...
<body>
    ...
    <header>
        ...
        <form class="container col-5 mt-5 borderFormConnexion" style="background-color: white;">
            ...
            <div class="text-center mt-5 pb-5">
                <a style="color: black;" href="">Mot de passe oublié</a>
            </div>
    ...
    <footer class="position-absolute bottom-0 start-50 translate-middle-x mb-3">
        <div class="row">
            <div class="col-auto">
                <a style="color: black;" href="">Nous contacter</a>
            </div>
            <div class="col">
                <p>Omnias 2023</p>
            </div>
