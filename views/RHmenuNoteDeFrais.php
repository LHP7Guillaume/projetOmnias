        ...
        <div class="container col-8 mt-5 borderFormConnexion" style="background-color: white;">
            ...
            <div class="container col-6">
                ...
                <div class="row text-center g-4">
                    <div class="">
                        <a class="myButton m-2 col-lg-4 btn btn-outline-secondary fs-3" href="">Demandes en cours</a>
                    </div>
                    <div>
                        <a class="myButton m-5 col-lg-4 btn btn-outline-secondary fs-3" href="">Notes Validés</a>
                    </div>
                </div>
